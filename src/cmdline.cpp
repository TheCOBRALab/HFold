/*
  ...
  gengetopt --input=hfold.ggo --c-extension=cpp --header-extension=hpp --arg-struct-name=args_info --unamed-opts=input
...
void init_args_info(struct args_info *args_info)
{
  ...
  args_info->opt_help = args_info_help[5] ;
      ...
      switch (c)
        ...
        case 'n':	/* Specify the number of suboptimal structures to output (default is 1).  */
          ...
          if (update_arg( (void *)&(args_info->opt_arg), 
              ...
              &(local_args_info.opt_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "opt", 'n',
              additional_error))
            goto failure;
