...
#define CMDLINE_PARSER_PACKAGE "HFold"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "HFold"
#endif
...
struct args_info
{
  ...
  int pk_free_flag;	/**< @brief Specify whether you only want the pseudoknot-free structure to be calculated (default=off).  */
  const char *pk_free_help; /**< @brief Specify whether you only want the pseudoknot-free structure to be calculated help description.  */
  int pk_only_flag;	/**< @brief Only add base pairs which cross the constraint structure. The constraint structure is returned if there are no energetically favorable crossing base pairs (default=off).  */
  const char *pk_only_help; /**< @brief Only add base pairs which cross the constraint structure. The constraint structure is returned if there are no energetically favorable crossing base pairs help description.  */
  ...
  unsigned int pk_free_given ;	/**< @brief Whether pk-free was given.  */
  unsigned int pk_only_given ;	/**< @brief Whether pk-only was given.  */
